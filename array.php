...
<body>
	...
	<a style="float:right; margin-top:20px;margin-left: 20px;  text-decoration: none;text-shadow: 3px; color: white ; font-weight: bold;" href="numbers.html"><i class="fa fa-arrow-circle-left" style="font-size:24px; color:white; text-shadow: 3px;"></i> Go back</a>
	<div>
<?php
