...
<head>
	...
	<a style="float:right; margin-top:20px;margin-left: 20px;  text-decoration: none;text-shadow: 3px; color: white ; font-weight: bold;" href="homepage.php"><i class="fa fa-arrow-circle-left" style="font-size:24px; color:white; text-shadow: 3px;"></i> Go back</a>
</head>
<body bgcolor="<?php echo $bgColor ?>">
	<a style="text-decoration: none; float: right; margin-right: 120px; margin-top: 50px; border: 1px solid plum; border-radius: 5px; background-color: white; padding: 5px;" href="array.php">Let's have some fun</a>
	<div>
		<h2>Numbers</h2>
<table>
	<tr>
